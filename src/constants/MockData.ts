import { IDiscoverList } from '../interfaces/DiscoverList';
import {IFavouriteMovieList} from '../interfaces/FavouriteList';
import {IGenresList} from '../interfaces/GenresList';
import {ITopMovieList} from '../interfaces/TopRatedList';

export const topRatedListMock: ITopMovieList = {
  page: 1,
  results: [
    {
      adult: false,
...
export const genresListMock: IGenresList = {
  genres: [
    {
      id: 28,
      name: 'Action',
...
export const favouriteListMock: IFavouriteMovieList = {
  page: 1,
  results: [
    {
      adult: false,
...
export const discoverListMock: IDiscoverList = {
  page: 1,
  results: [
    {
      adult: false,
